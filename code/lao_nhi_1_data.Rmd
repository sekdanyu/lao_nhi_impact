...
<br>
```{r opd_ipd_mch, message=FALSE, warning=FALSE}
...
# EPI and growth data
<br>
```{r epi_growth, message=FALSE, warning=FALSE}
...
write_xlsx(data.lsb, "./data export/01_data_pop_lsb.xlsx")
