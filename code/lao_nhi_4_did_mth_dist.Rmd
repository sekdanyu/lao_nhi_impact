...
# -----------------------------------
# 1st treated (07/2016): 17 ATP, 
# 2nd treated (08/2016): 03 LNT, 18 XSB
# 3rd treated (12/2016): 14 SRV
# 4th treated (01/2017): 11 BKX, 07 HPN, 09 XKG, 
# 5th treated (Q2/2017): 04 ODX, 02 PSL
# 6th treated (09/2017): 13 SVK, 16 CPS
# 7th treated (10/2017): 05 BKO, 12 KMN, 06 LPG, 08 XYB, 10 VTP
...
listv <- c("v", "v.cls", 
           "vc", "vc.cls.p", "vc.clslast", "vc.clsant1")
attgt_list_v <- lapply(listv, get)

listu <- c("u", "u.cls", 
           "uc", "uc.cls.p", "uc.clslast", "uc.clsant1")
...
# A9. Robustness check: Controlled interrupted time series analysis (monthly)
<br>
```{r cits}
...
its_meta_final_m <- bind_rows(meta_summary_df) 
# %>%
